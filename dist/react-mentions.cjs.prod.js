...
var SuggestionsOverlay = function(_Component) {
  ...
  return _inherits(SuggestionsOverlay, _Component), _createClass(SuggestionsOverlay, [ {
    ...
    value: function() {
      ...
      return this.props.renderDropdown ? this.props.renderDropdown(_objectSpread({}, props, {
        isLoading: this.props.isLoading,
        children: this.renderSuggestions()
      })) : React__default.createElement("div", _extends({}, useStyles.inline({
        ...
        onMouseDown: onMouseDown,
        ref: containerRef
      }), React__default.createElement("ul", _extends({}, props, style("list")), this.renderSuggestions()));
    }
  }, {
...
var makeTriggerRegex = function(trigger) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setContainerElement", function(el) {
      ...
      return _objectSpread$1({}, omit(_this.props, [ "style", "classNames", "className" ], keys(propTypes)), {}, style("input"), {
      ...
      return "function" == typeof _this.props.renderInput ? _this.props.renderInput({
        inputProps: props,
      ...
      return "function" == typeof _this.props.renderTextarea ? _this.props.renderTextarea({
        inputProps: props,
        ref: _this.setInputRef
